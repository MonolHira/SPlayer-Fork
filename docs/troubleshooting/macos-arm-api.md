...
1. 访问 [GitHub Releases](https://github.com/MonolHira/SPlayer-Fork/releases)
2. 下载文件名包含 `arm64` 的版本
3. 删除旧版本后重新安装
...
如果上述方法都无法解决问题，请在 [GitHub Issues](https://github.com/MonolHira/SPlayer-Fork/issues) 提交问题，并附上：
